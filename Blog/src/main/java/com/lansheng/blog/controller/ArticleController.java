...
public class ArticleController {
    ...
    @ApiImplicitParam(name = "file", value = "文章图片", required = true, dataType = "MultipartFile")//     MultipartFile是org.springframework.web.mutipart包下的一个类，需引入Springboot框架。一般来说是实现文件上传的功能
